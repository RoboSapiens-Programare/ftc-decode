...
public class AutoMotif extends LinearOpMode {
    ...
    private org.firstinspires.ftc.teamcode.TeleOP.FSM FSM = new org.firstinspires.ftc.teamcode.TeleOP.FSM();
    ...
    public void buildPathsAny()
    {
        ...
        // here you make the first path just in case you change the startPose to a pos where you cant score
