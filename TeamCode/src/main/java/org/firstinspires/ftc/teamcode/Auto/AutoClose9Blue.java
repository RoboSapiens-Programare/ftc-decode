...
@Autonomous(name = "Auto Close x9 BLUE", group = "0. Auto")
public class AutoClose9Blue extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            shoot0 =
                    follower.pathBuilder()
                            .addPath(new BezierLine(new Pose(15, 83.000), new Pose(60.500, 90.000)))
                            .setLinearHeadingInterpolation(
            ...
            shoot1 =
                    follower.pathBuilder()
                            .addPath(new BezierLine(new Pose(15, 61.000), new Pose(60.500, 90.000)))
                            .setLinearHeadingInterpolation(
