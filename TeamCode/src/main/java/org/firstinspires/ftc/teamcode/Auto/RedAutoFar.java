...
@Autonomous(name = "Red Auto Far", group = "0. Autonomous")
@Configurable // Panels
public class RedAutoFar extends OpMode {
    ...
    public void init() {
        ...
        Robot.follower.setStartingPose(new Pose(144-56, 8, Math.toRadians(90)));
                    ...
                    follower.pathBuilder()
                            .addPath(
                                    new BezierCurve(
                                            ...
                                            new Pose(144-67.000, 91.000),
                                            new Pose(144-41.000, 102.000)))
                            .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(90+45))
                            .build();
